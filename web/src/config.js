...
export const SPECIAL_SPRITE_SCALE = {
  ...
  '0130': 0.5,  // 暴鲤龙
  '0148': 0.7, // 哈克龙：盘绕
  '0162': 0.75, // 大尾立：躯干很短，长尾盘绕收纳
  '0206': 0.75, // 土龙弟弟：分段长虫蜷缩成团
  '0982': 0.7,  // 土龙节节：同上，常态盘成一团
  '0990': 0.8,  // 铁辙迹：分段长蠕虫弯曲匍匐
  '0336': 0.75, // 饭匙蛇：S 形长蛇
  '0497': 0.8,  // 君主蛇：身体 S 形卷曲站立，并未拉直
  '0844': 0.65, // 沙螺蟒：永久螺旋盘卷身体
  '0095': 0.8,  // 大岩蛇：岩蛇弯曲摆放
  '0208': 0.8,  // 大钢蛇：巨型钢蛇 S 形弯曲
  '0384': 0.85, // 烈空坐：弧形盘旋，不会完全拉直
  '0487': 0.85, // 起源形态骑拉帝纳：带状长身卷曲漂浮
};
